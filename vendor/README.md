...
| `audio.sv` | `console/src/audio.sv` | `0e9ef0d` (2026-07-22) | ⭐ **on real hardware**: this jack, on this board — console's `tune_top.sv` played Ode to Joy out of the ULX3S's onboard 3.5 mm socket on 2026-08-04. ⚠️ What was proven there is the JACK and the pin sites; console drives the ladder with a 1-bit sigma-delta on all four pins, koti drives it as a real 4-bit DAC through `src/audio_r2r.sv` |
